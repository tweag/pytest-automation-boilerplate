...
from main.lib.pytest_testrail_client.pytest_testrail_client import _step_error
from main.utils.utils import save_base64_as_png, TEMP_SCREENSHOTS, logger
...
def configure_driver_executor(session_capabilities, driver_options_factory):
    ...
    elif os.environ.get("USING_ENV", "") == 'LAMDATEST':
        value, options = driver_options_factory
