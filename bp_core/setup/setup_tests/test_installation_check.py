...
def test_check_bp_core_folder():
    ...
    assert_that(os.path.isdir("./bp_core/setup")).is_true()
...
def test_check_step_definitions_folder():
    ...
    assert_that(os.path.isfile("./bp_core/frontend/common/step_definitions/browser_navigation.py")).is_true()
    assert_that(os.path.isfile("./bp_core/frontend/common/step_definitions/click_touch_and_keyboard_actions.py")).is_true()
    assert_that(os.path.isfile("./bp_core/frontend/common/step_definitions/date_time.py")).is_true()
    assert_that(os.path.isfile("./bp_core/frontend/common/step_definitions/dropdowns.py")).is_true()
    assert_that(os.path.isfile("./bp_core/frontend/common/step_definitions/attribute_assertion.py")).is_true()
    ...
    assert_that(os.path.isfile("./bp_core/frontend/common/step_definitions/swipe_drag_and_drop.py")).is_true()
    assert_that(os.path.isfile("./bp_core/frontend/common/step_definitions/text_assertion_editing.py")).is_true()
...
def test_check_installation_folder():
    assert_that(os.path.isdir("./bp_core/setup")).is_true()
    assert_that(os.path.isdir("./bp_core/setup/setup_scripts")).is_true()
    assert_that(os.path.isdir("./bp_core/setup/setup_tests")).is_true()
    assert_that(
        os.path.isfile("./bp_core/setup/setup_scripts/download_assets.py")
    ).is_true()
